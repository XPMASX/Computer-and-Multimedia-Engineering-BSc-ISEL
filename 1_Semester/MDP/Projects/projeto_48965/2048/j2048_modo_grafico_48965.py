...
pygame.mixer.init()
pygame.mixer.pre_init(44100,16,2,4096) # iniciacao do mixer (frequencia, bits, saidas, buffer)
pygame.init()
...
pygame.display.set_caption("2048 - JOEL MACHADO") # nome da janela
...
#################### VERIFICA SE O JOGADOR PERDEU ###################################
            ...
            if jogo[1] == True:
                ...
                load_audio(".\end_theme.wav",volume_end,-1)
                estado_jogo = 'fim'

...
public class Livro extends Obra {
	...
	public String toString() {
		return super.toString() + Arrays.toString(this.autores);
	}

	/**
	 * Iguais se equals no contexto de obra e se o objecto recebido for um Livro.
	 * Deve utilizar o método equals de Obra
	 */
	@Override
	public boolean equals(Object l) {
		// Verificamos se o Objeto l é do tipo Livro, e se for, usamos o equals da classe Obra
		return (l instanceof Livro) && (super.equals(l));
	}

...
public class Eye {
    ...
    protected boolean nearSight(PVector t)
    {
    ...
    public void display(PApplet p, SubPlot plt)
    {
        ...
        p.stroke(255,0,0);
        p.strokeWeight(3);
        float[] dd1 = plt.getDimPixel(me.dna.visionDistance, me.dna.visionDistance);
        float[] dd2 = plt.getDimPixel(me.dna.visionSafeDistance, me.dna.visionSafeDistance);

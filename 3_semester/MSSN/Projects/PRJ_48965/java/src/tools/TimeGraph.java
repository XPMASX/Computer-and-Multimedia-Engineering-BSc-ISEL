...
public class TimeGraph {
    ...
    public TimeGraph(PApplet p, SubPlot plt, int color, float ref, String name) {
        this.color = new int[1];
        this.color[0] = color;
        initGraph(p, plt, this.color, ref, name);
    }

    public TimeGraph(PApplet p, SubPlot plt, int[] color, float ref, String name) {
        initGraph(p, plt, color, ref, name);
    }


    private void initGraph(PApplet p, SubPlot plt, int[] color, float ref, String name) {
        this.p = p;
        this.plt = plt;
        this.color = color;
